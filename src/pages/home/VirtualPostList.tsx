  ...
  return Array.from({ length: count }).map((_, i): PostItem => {
    ...
    switch (postType) {
      case PostType.ARTICLE:
        ...
        console.log(`[文章帖] ID: ${id}, hasAbstract: ${hasAbstract}, isLongArticle: ${isLongArticle}`);
...
这篇文章希望能够为读者提供有价值的见解和思考，帮助大家在技术发展的浪潮中找到自己的方向。`
        ...
        return {
          ...
          abstract: hasAbstract ? `本文深入探讨了${category}领域的核心概念、发展趋势和实际应用，通过理论分析和实践案例相结合的方式，为读者提供全面而深入的专业见解。` : undefined,
          content: longContent,
          wordCount: isLongArticle ? Math.floor(Math.random() * 8000) + 6000 : Math.floor(Math.random() * 4000) + 2000,
        };
      ...
      case PostType.IMAGE:
        ...
        console.log(`[图片帖] ID: ${id}, isImagePost: ${isImagePost}, hasMoreImages: ${hasMoreImages}, imageCount: ${imageCount}`);
      ...
      case PostType.DYNAMIC:
        ...
        console.log(`[动态帖] ID: ${id}, isDynamicPost: ${isDynamicPost}, hasManyImages: ${hasManyImages}, imageCount: ${dynamicImageCount}`);
